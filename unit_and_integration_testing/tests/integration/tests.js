...
describe('calculator functionality', function() {
  ...
  it('should update the running total', function(){
    running_total = element(by.css('#running_total'))
  ...
  it('should update the display with the result of the arithmetical operators', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number3')).click();
    element(by.css('#number2')).click();
  ...
  it("should output -2 when 2-4 is performed", function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number2')).click();
  ...
  it('should handle decimals, so 3/2 should return 1.5', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number3')).click();
    element(by.css('#operator_divide')).click();
    element(by.css('#number2')).click();
  ...
  it('should handle large numbers, so 9999*9999 should return 99980001', function(){
    running_total = element(by.css('#running_total'))
  ...
  it('should return undfined if you try to divide by zero', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number3')).click();
    element(by.css('#operator_divide')).click();
